...
- [x] Pain không chứa tên feature
- [x] Có hai cách giải thích cạnh tranh
- [x] Có điều kiện bác bỏ hypothesis

## Gate 2 — Interview Design

- [x] Big 3 nối với Evidence Map
- [x] Story opener hỏi sự kiện gần đây
- [x] Không hỏi “bạn có muốn/dùng feature không?”
- [x] Có scary question có thể làm hypothesis yếu đi

## Gate 3 — Interview Practice

- [ ] Có interviewee thật đáp ứng recruitment check
- [ ] Đã xin consent trước khi ghi âm
- [ ] `interview/notes.md` chứa notes thật
- [ ] Có recording hoặc recording link mở được với giảng viên/TA

## Gate 4 — Reflection & Revision

- [ ] Điền moment cụ thể từ practice vào Reflection
- [ ] Ghi ít nhất một lỗi interview thật
- [ ] Ghi ít nhất một thay đổi guide thực sự phát sinh sau practice

---

# 9. Checklist trước khi nộp

- [ ] Đổi tên repo thành `Track1_Day17_MHV_HoVaTen`
- [ ] Điền MHV, họ tên, tên nhóm, thành viên
- [ ] Phỏng vấn/role-practice với người thật
- [ ] Xin consent trước khi record
- [ ] Thay placeholder trong `interview/notes.md`
- [ ] Thêm `recording.m4a` hoặc cập nhật `recording-link.md`
- [ ] Điền ba chỗ `[ĐIỀN]` trong Practice Reflection
- [ ] Xóa file `interview/mock-practice-example.md` nếu không muốn nộp tài liệu luyện
- [ ] Kiểm tra link/bản ghi không để public
- [ ] Push repo và test quyền truy cập
